          ...
          <div className="flex-shrink-0 bg-black/20 p-4 rounded border border-gray-700 relative min-h-[400px]">
            {loadError ? (
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
                    ...
                    <span className="text-[var(--accent-primary)] animate-pulse text-sm font-medium">Generating Visualization...</span>
                </div>
            )}

            <div className={`transition-opacity duration-500 ${isReady ? 'opacity-100 visible' : 'opacity-0 invisible'}`}>
