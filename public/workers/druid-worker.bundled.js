...
/***/ "./node_modules/@saehrimnir/druidjs/src/clustering/Hierarchical_Clustering.js":
/*!************************************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/clustering/Hierarchical_Clustering.js ***!
  \************************************************************************************/
...
/* harmony export */ });
/* harmony import */ var _metrics_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../metrics/index.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/index.js");
/* harmony import */ var _matrix_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../matrix/index.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/index.js");
...
class Hierarchical_Clustering {
     ...
     */
    constructor(matrix, linkage = "complete", metric = _metrics_index_js__WEBPACK_IMPORTED_MODULE_0__.euclidean) {
        this._id = 0;
        this._matrix = matrix instanceof _matrix_index_js__WEBPACK_IMPORTED_MODULE_1__.Matrix ? matrix : _matrix_index_js__WEBPACK_IMPORTED_MODULE_1__.Matrix.from(matrix);
        this._metric = metric;
    ...
    init() {
        ...
        if (metric !== "precomputed") {
            distance_matrix = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_1__.Matrix(n, n, 0); //new Array(n);
            for (let i = 0; i < n; ++i) {
                d_min[i] = 0;
...
/***/ "./node_modules/@saehrimnir/druidjs/src/clustering/KMeans.js":
/*!*******************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/clustering/KMeans.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _metrics_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../metrics/index.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/index.js");
/* harmony import */ var _util_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../util/index.js */ "./node_modules/@saehrimnir/druidjs/src/util/index.js");
/* harmony import */ var _datastructure_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../datastructure/index.js */ "./node_modules/@saehrimnir/druidjs/src/datastructure/index.js");
/* harmony import */ var _matrix_index_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../matrix/index.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/index.js");
...
class KMeans {
     ...
     * @returns {KMeans}
     */
    constructor(matrix, K, metric = _metrics_index_js__WEBPACK_IMPORTED_MODULE_0__.euclidean, seed=1987, init = true) {
        this._metric = metric;
        this._matrix = matrix;
        this._K = K;
        ...
        this._D = D;
        if (K > N) K = N;
        this._randomizer = new _util_index_js__WEBPACK_IMPORTED_MODULE_1__.Randomizer(seed);
    ...
    _furthest_point(points, candidates) {
        ...
        const metric = this._metric;
        let i = points.length;
        let H = _datastructure_index_js__WEBPACK_IMPORTED_MODULE_2__.Heap.heapify(
            candidates, 
            (d) => {
                const Ad = A.row(d)
                let sum = 0;
    ...
    _get_random_centroids(K) {
        ...
        const indices = (0,_matrix_index_js__WEBPACK_IMPORTED_MODULE_3__.linspace)(0, N - 1);
...
/***/ "./node_modules/@saehrimnir/druidjs/src/clustering/KMedoids.js":
/*!*********************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/clustering/KMedoids.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _metrics_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../metrics/index.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/index.js");
/* harmony import */ var _util_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../util/index.js */ "./node_modules/@saehrimnir/druidjs/src/util/index.js");
/* harmony import */ var _matrix_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../matrix/index.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/index.js");
...
class KMedoids {
     ...
     */
    constructor(matrix, K, max_iter=null, metric = _metrics_index_js__WEBPACK_IMPORTED_MODULE_0__.euclidean, seed=1212) {
        this._metric = metric;
        this._matrix = matrix;
        ...
        this._distance_matrix = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_2__.Matrix(N, N, "zeros");
        /* for (let i = 1; i < N; ++i) {
            for (let j = i + 1; j < N; ++j) {
    ...
    _iteration() {
        ...
        if ((0,_util_index_js__WEBPACK_IMPORTED_MODULE_1__.min)(DeltaTD) >= 0) return true; 

        // execute all improvements
        while ((0,_util_index_js__WEBPACK_IMPORTED_MODULE_1__.min)(DeltaTD) < 0) {
    ...
    _get_random_medoids(K) {
        const N = this._N;
        const A = this._A;
        const indices = (0,_matrix_index_js__WEBPACK_IMPORTED_MODULE_2__.linspace)(0, N - 1);
        const randomizer = this._randomizer;
        ...
        for (let i = 1; i < K; ++i) {
            ...
            for (let j = 0; j < n; ++j) {
                ...
                for (let o = 0; o < n; ++o) {
                    ...
                    const S_o = S[o];
                    const x_o = A[S_o];
                    let delta = this._get_distance(S_j, S_o, x_j, x_o) - (0,_util_index_js__WEBPACK_IMPORTED_MODULE_1__.min)(medoids.map(m => this._get_distance(S_o, m, x_o)));
                    if (delta < 0) {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/clustering/OPTICS.js":
/*!*******************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/clustering/OPTICS.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _metrics_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../metrics/index.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/index.js");
/* harmony import */ var _datastructure_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../datastructure/index.js */ "./node_modules/@saehrimnir/druidjs/src/datastructure/index.js");
...
class OPTICS {
     ...
     */
    constructor(matrix, epsilon, min_points, metric = _metrics_index_js__WEBPACK_IMPORTED_MODULE_0__.euclidean) {
        this._matrix = matrix;
    ...
    init() {
        ...
        for (const p of DB) {
            ...
            if (this._core_distance(p) != undefined) {
                const seeds = new _datastructure_index_js__WEBPACK_IMPORTED_MODULE_1__.Heap(null, d => d.reachability_distance, "min")
        ...
        for (const q of neighbors) {
            ...
            if (seeds.raw_data().findIndex(d => d.element == q) < 0) {
                ...
                if (new_reachability_distance < q.reachability_distance) {
                    q.reachability_distance = new_reachability_distance;
                    seeds = _datastructure_index_js__WEBPACK_IMPORTED_MODULE_1__.Heap.heapify(seeds.data(), d => d.reachability_distance, "min"); // seeds change key =/
                }
            }
        }
    }
...
/***/ "./node_modules/@saehrimnir/druidjs/src/clustering/index.js":
/*!******************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/clustering/index.js ***!
  \******************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Hierarchical_Clustering: () => (/* reexport safe */ _Hierarchical_Clustering_js__WEBPACK_IMPORTED_MODULE_0__.Hierarchical_Clustering),
/* harmony export */   KMeans: () => (/* reexport safe */ _KMeans_js__WEBPACK_IMPORTED_MODULE_1__.KMeans),
/* harmony export */   KMedoids: () => (/* reexport safe */ _KMedoids_js__WEBPACK_IMPORTED_MODULE_2__.KMedoids),
/* harmony export */   OPTICS: () => (/* reexport safe */ _OPTICS_js__WEBPACK_IMPORTED_MODULE_3__.OPTICS)
/* harmony export */ });
/* harmony import */ var _Hierarchical_Clustering_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Hierarchical_Clustering.js */ "./node_modules/@saehrimnir/druidjs/src/clustering/Hierarchical_Clustering.js");
/* harmony import */ var _KMeans_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./KMeans.js */ "./node_modules/@saehrimnir/druidjs/src/clustering/KMeans.js");
/* harmony import */ var _KMedoids_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./KMedoids.js */ "./node_modules/@saehrimnir/druidjs/src/clustering/KMedoids.js");
/* harmony import */ var _OPTICS_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./OPTICS.js */ "./node_modules/@saehrimnir/druidjs/src/clustering/OPTICS.js");
/**
 * @module clustering
 */
...
/***/ "./node_modules/@saehrimnir/druidjs/src/datastructure/DisjointSet.js":
/*!***************************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/datastructure/DisjointSet.js ***!
  \***************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/datastructure/Heap.js":
/*!********************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/datastructure/Heap.js ***!
  \********************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/datastructure/index.js":
/*!*********************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/datastructure/index.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DisjointSet: () => (/* reexport safe */ _DisjointSet_js__WEBPACK_IMPORTED_MODULE_1__.DisjointSet),
/* harmony export */   Heap: () => (/* reexport safe */ _Heap_js__WEBPACK_IMPORTED_MODULE_0__.Heap)
/* harmony export */ });
/* harmony import */ var _Heap_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Heap.js */ "./node_modules/@saehrimnir/druidjs/src/datastructure/Heap.js");
/* harmony import */ var _DisjointSet_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DisjointSet.js */ "./node_modules/@saehrimnir/druidjs/src/datastructure/DisjointSet.js");
/**
...
/***/ "./node_modules/@saehrimnir/druidjs/src/dimred/DR.js":
/*!***********************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/dimred/DR.js ***!
  \***********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../matrix/index.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/index.js");
/* harmony import */ var _util_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../util/index.js */ "./node_modules/@saehrimnir/druidjs/src/util/index.js");
...
class DR {
    ...
    constructor(X, default_parameters, parameters) {
        ...
        if (Array.isArray(X)) {
            this._type = "array";
            this.X = _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix.from(X);
        } else if (X instanceof _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix) {
            this._type = "matrix";
            this.X = X;
        } else {
        ...
        this._randomizer = new _util_index_js__WEBPACK_IMPORTED_MODULE_1__.Randomizer(this._parameters.seed);
        this._is_initialized = false;
        return this;
    }
...
/***/ "./node_modules/@saehrimnir/druidjs/src/dimred/FASTMAP.js":
/*!****************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/dimred/FASTMAP.js ***!
  \****************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../matrix/index.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/index.js");
/* harmony import */ var _metrics_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../metrics/index.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/index.js");
/* harmony import */ var _DR_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DR.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/DR.js");
...
class FASTMAP extends _DR_js__WEBPACK_IMPORTED_MODULE_2__.DR {
    ...
    constructor(X, parameters) {
        super(X, { d: 2, metric: _metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean, seed: 1212 }, parameters);
        return this;
    }
    ...
    transform() {
        ...
        const Y = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, d, 0);
...
/***/ "./node_modules/@saehrimnir/druidjs/src/dimred/ISOMAP.js":
/*!***************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/dimred/ISOMAP.js ***!
  \***************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _linear_algebra_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../linear_algebra/index.js */ "./node_modules/@saehrimnir/druidjs/src/linear_algebra/index.js");
/* harmony import */ var _matrix_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../matrix/index.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/index.js");
/* harmony import */ var _datastructure_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../datastructure/index.js */ "./node_modules/@saehrimnir/druidjs/src/datastructure/index.js");
/* harmony import */ var _DR_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./DR.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/DR.js");
/* harmony import */ var _metrics_euclidean_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../metrics/euclidean.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/euclidean.js");
 ...
 * @extends DR
 */
class ISOMAP extends _DR_js__WEBPACK_IMPORTED_MODULE_3__.DR {
    /**
     ...
     */
    constructor(X, parameters) {
        super(X, { neighbors: undefined, d: 2, metric: _metrics_euclidean_js__WEBPACK_IMPORTED_MODULE_4__["default"], seed: 1212, eig_args: {} }, parameters);
    ...
    transform() {
        ...
        const D = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_1__.Matrix();
        ...
        for (let i = 0; i < rows; ++i) {
            ...
            const H = new _datastructure_index_js__WEBPACK_IMPORTED_MODULE_2__.Heap(row, (d) => d.distance, "min");
        ...
        const G = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_1__.Matrix(rows, rows, (i, j) => {
        ...
        let a__ = 0;
        const A = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_1__.Matrix(rows, rows, (i, j) => {
            let val = G.entry(i, j);
        ...
        a__ /= rows ** 2;
        const B = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_1__.Matrix(rows, rows, (i, j) => A.entry(i, j) - ai_[i] - a_j[j] + a__);

        // compute d eigenvectors
        const { eigenvectors: V } = (0,_linear_algebra_index_js__WEBPACK_IMPORTED_MODULE_0__.simultaneous_poweriteration)(B, d, eig_args);
        this.Y = _matrix_index_js__WEBPACK_IMPORTED_MODULE_1__.Matrix.from(V).transpose();
        // return embedding
        return this.projection;
    }
}
...
/***/ "./node_modules/@saehrimnir/druidjs/src/dimred/LDA.js":
/*!************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/dimred/LDA.js ***!
  \************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../matrix/index.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/index.js");
/* harmony import */ var _linear_algebra_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../linear_algebra/index.js */ "./node_modules/@saehrimnir/druidjs/src/linear_algebra/index.js");
/* harmony import */ var _DR_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DR.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/DR.js");
 ...
 * @extends DR
 */
class LDA extends _DR_js__WEBPACK_IMPORTED_MODULE_2__.DR {
    /**
    ...
    transform() {
        ...
        const X_mean = X.mean;
        const V_mean = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(label_id, cols);
        for (const label in unique_labels) {
            const V = _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix.from(unique_labels[label].rows);
        ...
        // scatter_between
        let S_b = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(cols, cols);
        for (const label in unique_labels) {
            const v = V_mean.row(unique_labels[label].id);
            const m = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(cols, 1, (j) => v[j] - X_mean);
            const N = unique_labels[label].count;
            S_b = S_b.add(m.dotTrans(m).mult(N));
        }

        // scatter_within
        let S_w = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(cols, cols);
        for (const label in unique_labels) {
            const v = V_mean.row(unique_labels[label].id);
            const m = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(cols, 1, (j) => v[j]);
            const R = unique_labels[label].rows;
            for (let i = 0, n = unique_labels[label].count; i < n; ++i) {
                const row_v = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(cols, 1, (j, _) => R[i][j] - m.entry(j, 0));
                S_w = S_w.add(row_v.dotTrans(row_v));
            }
        }

        let { eigenvectors: V } = (0,_linear_algebra_index_js__WEBPACK_IMPORTED_MODULE_1__.simultaneous_poweriteration)(S_w.inverse().dot(S_b), d, eig_args);
        V = _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix.from(V).transpose();
        this.Y = X.dot(V);
...
/***/ "./node_modules/@saehrimnir/druidjs/src/dimred/LLE.js":
/*!************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/dimred/LLE.js ***!
  \************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../matrix/index.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/index.js");
/* harmony import */ var _metrics_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../metrics/index.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/index.js");
/* harmony import */ var _linear_algebra_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../linear_algebra/index.js */ "./node_modules/@saehrimnir/druidjs/src/linear_algebra/index.js");
/* harmony import */ var _numerical_index_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../numerical/index.js */ "./node_modules/@saehrimnir/druidjs/src/numerical/index.js");
/* harmony import */ var _DR_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./DR.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/DR.js");
...
class LLE extends _DR_js__WEBPACK_IMPORTED_MODULE_4__.DR {
     ...
     */
    constructor(X, parameters) {
        super(X, { neighbors: undefined, d: 2, metric: _metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean, seed: 1212, eig_args: {} }, parameters);
    ...
    transform() {
        ...
        const nN = (0,_matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.k_nearest_neighbors)(X, neighbors, metric);
        const O = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(neighbors, 1, 1);
        const W = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(rows, rows);

        for (let row = 0; row < rows; ++row) {
            const nN_row = nN[row];
            const Z = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(neighbors, cols, (i, j) => X.entry(nN_row[i].j, j) - X.entry(row, j));
            const C = Z.dotTrans(Z);
            if (neighbors > cols) {
                const C_trace = (0,_numerical_index_js__WEBPACK_IMPORTED_MODULE_3__.neumair_sum)(C.diag) / 1000;
                for (let j = 0; j < neighbors; ++j) {
                    C.add_entry(j, j, C_trace);
                }
            }
            // reconstruct;
            let w = _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix.solve_CG(C, O, this._randomizer);
            w = w.divide(w.sum);
            for (let j = 0; j < neighbors; ++j) {
        ...
        // comp embedding
        const I = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(rows, rows, "identity");
        const IW = I.sub(W);
        const M = IW.transDot(IW);
        const { eigenvectors: V } = (0,_linear_algebra_index_js__WEBPACK_IMPORTED_MODULE_2__.simultaneous_poweriteration)(M.T.inverse(), d + 1, eig_args);
        this.Y = _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix.from(V.slice(1, 1 + d)).T;
...
/***/ "./node_modules/@saehrimnir/druidjs/src/dimred/LSP.js":
/*!************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/dimred/LSP.js ***!
  \************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../matrix/index.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/index.js");
/* harmony import */ var _DR_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DR.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/DR.js");
/* harmony import */ var _MDS_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MDS.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/MDS.js");
/* harmony import */ var _clustering_index_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../clustering/index.js */ "./node_modules/@saehrimnir/druidjs/src/clustering/index.js");
/* harmony import */ var _metrics_index_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../metrics/index.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/index.js");
/* harmony import */ var _knn_index_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../knn/index.js */ "./node_modules/@saehrimnir/druidjs/src/knn/index.js");
...
class LSP extends _DR_js__WEBPACK_IMPORTED_MODULE_1__.DR {
     ...
     */
    constructor(X, parameters) {
        super(X, { neighbors: undefined, control_points: undefined, d: 2, metric: _metrics_index_js__WEBPACK_IMPORTED_MODULE_4__.euclidean, seed: 1212 }, parameters);
        this.parameter("neighbors", Math.min(this._parameters.neighbors ?? Math.max(Math.floor(this._N / 10), 2), this._N - 1));
     ...
     * @returns {LSP}
     */
    init(DR = _MDS_js__WEBPACK_IMPORTED_MODULE_2__.MDS, DR_parameters = {}, KNN = _knn_index_js__WEBPACK_IMPORTED_MODULE_5__.BallTree) {
        ...
        const control_points = new _clustering_index_js__WEBPACK_IMPORTED_MODULE_3__.KMedoids(X, nc, null, metric).get_clusters().medoids;
        const C = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(nc, N, "zeros");
        control_points.forEach((c_i, i) => {
            C.set_entry(i, c_i, 1);
        });
        const Y_C = new DR(_matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix.from(control_points.map((c_i) => X.row(c_i))), DR_parameters).transform();

        const XA = X.to2dArray;
        const knn = new KNN(XA, metric);
        const L = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, N, "I");
        const alpha = -1 / K;
        XA.forEach((x_i, i) => {
        ...
        const z = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, d, "zeros");
    ...
    transform() {
        ...
        this.Y = _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix.solve_CG(ATA, ATb, this._randomizer);
        return this.projection;
    }
}
...
/***/ "./node_modules/@saehrimnir/druidjs/src/dimred/LTSA.js":
/*!*************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/dimred/LTSA.js ***!
  \*************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
class LTSA extends _DR_js__WEBPACK_IMPORTED_MODULE_3__.DR {
    ...
    transform() {
        ...
        const nN = (0,_matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.k_nearest_neighbors)(X, neighbors, metric);
        // center matrix
        const O = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(D, D, "center");
        const B = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(rows, rows, 0);

        for (let row = 0; row < rows; ++row) {
            // 1.2 compute the d largest eigenvectors of the correlation matrix
            const I_i = [row, ...nN[row].map((n) => n.j)];
            let X_i = _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix.from(I_i.map((n) => X.row(n)));
            // center X_i
            X_i = X_i.dot(O);
            // correlation matrix
            const C = X_i.dotTrans(X_i);
            const { eigenvectors: g } = (0,_linear_algebra_index_js__WEBPACK_IMPORTED_MODULE_2__.simultaneous_poweriteration)(C, d, eig_args);
            //g.push(linspace(0, k).map(_ => 1 / Math.sqrt(k + 1)));
            const G_i_t = _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix.from(g);
        ...
        const { eigenvectors: Y } = (0,_linear_algebra_index_js__WEBPACK_IMPORTED_MODULE_2__.simultaneous_poweriteration)(B, d + 1, eig_args);
        this.Y = _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix.from(Y.slice(1)).transpose();
...
/***/ "./node_modules/@saehrimnir/druidjs/src/dimred/MDS.js":
/*!************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/dimred/MDS.js ***!
  \************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _linear_algebra_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../linear_algebra/index.js */ "./node_modules/@saehrimnir/druidjs/src/linear_algebra/index.js");
/* harmony import */ var _matrix_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../matrix/index.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/index.js");
/* harmony import */ var _metrics_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../metrics/index.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/index.js");
/* harmony import */ var _DR_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./DR.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/DR.js");
...
class MDS extends _DR_js__WEBPACK_IMPORTED_MODULE_3__.DR {
     ...
     */
    constructor(X, parameters) {
        super(X, { d: 2, metric: _metrics_index_js__WEBPACK_IMPORTED_MODULE_2__.euclidean, seed: 1212, eig_args: {} }, parameters);
        if (!this._parameters.eig_args.hasOwnProperty("seed")) {
            this._parameters.eig_args.seed = this._randomizer;
        }
        return this;
    ...
    transform() {
        ...
        const A = metric === "precomputed" ? X : (0,_matrix_index_js__WEBPACK_IMPORTED_MODULE_1__.distance_matrix)(X, metric);
    ...
    stress() {
        ...
        const Y = this.Y;
        const d_X = this._d_X;
        const d_Y = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_1__.Matrix();
        d_Y.shape = [
            N,
            N,
            (i, j) => {
                return i < j ? (0,_metrics_index_js__WEBPACK_IMPORTED_MODULE_2__.euclidean)(Y.row(i), Y.row(j)) : d_Y.entry(j, i);
            },
        ];
        let top_sum = 0;
        let bottom_sum = 0;
...
/***/ "./node_modules/@saehrimnir/druidjs/src/dimred/PCA.js":
/*!************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/dimred/PCA.js ***!
  \************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
class PCA extends _DR_js__WEBPACK_IMPORTED_MODULE_2__.DR {
    ...
    transform(A = null) {
        ...
        if (A == null) {
            ...
            return _matrix_index_js__WEBPACK_IMPORTED_MODULE_1__.Matrix.from(A).dot(V).asArray;
        } else if (A instanceof _matrix_index_js__WEBPACK_IMPORTED_MODULE_1__.Matrix) {
            return A.dot(V);
        } else {
    ...
    principal_components() {
        ...
        const { eigenvectors: V } = (0,_linear_algebra_index_js__WEBPACK_IMPORTED_MODULE_0__.simultaneous_poweriteration)(C, d, eig_args);
        this.V = _matrix_index_js__WEBPACK_IMPORTED_MODULE_1__.Matrix.from(V).transpose();
        return this.V;
    }
...
/***/ "./node_modules/@saehrimnir/druidjs/src/dimred/SAMMON.js":
/*!***************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/dimred/SAMMON.js ***!
  \***************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _metrics_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../metrics/index.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/index.js");
/* harmony import */ var _DR_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DR.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/DR.js");
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/index.js");
...
class SAMMON extends _DR_js__WEBPACK_IMPORTED_MODULE_2__.DR {
     ...
     */
    constructor(X, parameters) {
        super(X, { magic: 0.1, d: 2, metric: _metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean, seed: 1212, init_DR: "random", init_parameters: {} }, parameters);
        return this;
    }
    ...
    init() {
        ...
        if (init_DR === "random") {
            const randomizer = this._randomizer;
            this.Y = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, d, () => randomizer.random);
        } else if (["PCA", "MDS"].includes(init_DR)) {
            this.Y = _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix.from(init_DR == "PCA" ? _index_js__WEBPACK_IMPORTED_MODULE_3__.PCA.transform(this.X, DR_parameters) : _index_js__WEBPACK_IMPORTED_MODULE_3__.MDS.transform(this.X, DR_parameters));
        } else {
            throw new Error('init_DR needs to be either "random" or a DR method!');
        }
        this.distance_matrix = metric == "precomputed" ? _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix.from(this.X) : (0,_matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.distance_matrix)(this.X, metric);
        return this;
    }
    ...
    *generator(max_iter = 200) {
    ...
    _step() {
        ...
        let G = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, d, 0);
...
/***/ "./node_modules/@saehrimnir/druidjs/src/dimred/SQDMDS.js":
/*!***************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/dimred/SQDMDS.js ***!
  \***************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SQDMDS: () => (/* binding */ SQDMDS)
/* harmony export */ });
/* harmony import */ var _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../matrix/index.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/index.js");
/* harmony import */ var _metrics_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../metrics/index.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/index.js");
/* harmony import */ var _numerical_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../numerical/index.js */ "./node_modules/@saehrimnir/druidjs/src/numerical/index.js");
/* harmony import */ var _DR_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./DR.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/DR.js");
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./index.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/index.js");
...
class SQDMDS extends _DR_js__WEBPACK_IMPORTED_MODULE_3__.DR {
    /**
    ...
    constructor(X, parameters) {
        super(
            ...
            {
                d: 2,
                metric: _metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean,
                seed: 1212,
                decay_start: 0.1,
                decay_cte: 0.34, // 0.34
                init_DR: { type: "random" },
    ...
    init() {
        ...
        this._momentums = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, d, 0);
        this._grads = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, d, 0);
        this._indices = (0,_matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.linspace)(0, N - 1);
        // initialize projection.
        const R = this._randomizer;
        this.Y = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, d, () => R.random - 0.5);
        ...
        if (this_metric === "precomputed") {
            ...
            if (this_metric == _metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean) {
                this._HD_metric_exaggeration = function (i, j, X) {
                    return (0,_metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean_squared)(X.row(i), X.row(j));
                };
            } else {
                this._HD_metric_exaggeration = function (i, j, X) {
    ...
    *generator(iterations = 500) {
    ...
    _nestrov_iteration(distance_exaggeration) {
        ...
        for (let i = 0; i < n; ++i) {
            ...
            const g_i_norm = (0,_matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.norm)(g_i);
    ...
    _fill_MDS_grads(Y, grads, exaggeration = false, zero_grad = true) {
        ...
        for (const [i, j, k, l] of quartets) {
            ...
            const D_quartet_sum = (0,_numerical_index_js__WEBPACK_IMPORTED_MODULE_2__.neumair_sum)(D_quartet);
    ...
    _compute_quartet_grads(Y, quartet, [p_ab, p_ac, p_ad, p_bc, p_bd, p_cd]) {
        ...
        const d_ab = (0,_metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean)(a, b) + 1e-12;
        const d_ac = (0,_metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean)(a, c) + 1e-12;
        const d_ad = (0,_metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean)(a, d) + 1e-12;
        const d_bc = (0,_metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean)(b, c) + 1e-12;
        const d_bd = (0,_metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean)(b, d) + 1e-12;
        const d_cd = (0,_metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean)(c, d) + 1e-12;
        const sum_LD_dist = (0,_numerical_index_js__WEBPACK_IMPORTED_MODULE_2__.neumair_sum)([d_ab, d_ac, d_ad, d_bc, d_bd, d_cd]);
...
/***/ "./node_modules/@saehrimnir/druidjs/src/dimred/TSNE.js":
/*!*************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/dimred/TSNE.js ***!
  \*************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
class TSNE extends _DR_js__WEBPACK_IMPORTED_MODULE_2__.DR {
     ...
     */
    constructor(X, parameters) {
        super(X, { perplexity: 50, epsilon: 10, d: 2, metric: _metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean_squared, seed: 1212 }, parameters);
        [this._N, this._D] = this.X.shape;
        this._iter = 0;
        this.Y = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(this._N, this.parameter("d"), () => this._randomizer.gauss_random() * 1e-4);
        return this;
    }
    ...
    init() {
        ...
        if (metric == "precomputed") {
            ...
            Delta = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, N);
            for (let i = 0; i < N; ++i) {
                const X_i = X.row(i);
                for (let j = i + 1; j < N; ++j) {
        ...
        const P = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, N, 0);

        this._ystep = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, D, 0);
        this._gains = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, D, 1);
    ...
    *generator(iterations = 500) {
    ...
    next() {
        ...
        const Qu = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, N, "zeros");
        let qsum = 0;
        for (let i = 0; i < N; ++i) {
            for (let j = i + 1; j < N; ++j) {
                let dsum = 0;
        ...
        // normalize Q dist
        const Q = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, N, 0);
        for (let i = 0; i < N; ++i) {
            for (let j = i + 1; j < N; ++j) {
        ...
        const grad = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, dim, "zeros");
        for (let i = 0; i < N; ++i) {
            for (let j = 0; j < N; ++j) {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/dimred/TopoMap.js":
/*!****************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/dimred/TopoMap.js ***!
  \****************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _metrics_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../metrics/index.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/index.js");
/* harmony import */ var _DR_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DR.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/DR.js");
/* harmony import */ var _datastructure_index_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../datastructure/index.js */ "./node_modules/@saehrimnir/druidjs/src/datastructure/index.js");
...
class TopoMap extends _DR_js__WEBPACK_IMPORTED_MODULE_2__.DR {
     ...
     */
    constructor(X, parameters) {
        super(X, { metric: _metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean, seed: 1212 }, parameters);
        [this._N, this._D] = this.X.shape;
        this._distance_matrix = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(this._N, this._N, 0);
        return this;
    }
     ...
     */
    _make_minimum_spanning_tree(metric = _metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean) {
        const N = this._N;
        const X = [...this.X];

        let disjoint_set = new _datastructure_index_js__WEBPACK_IMPORTED_MODULE_3__.DisjointSet(X);
        const F = [];
        let E = [];
        for (let i = 0; i < N; ++i) {
            for (let j = i + 1; j < N; ++j) {
    ...
    init() {
        const { metric } = this._parameters;
        this.Y = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(this._N, 2, 0);
    ...
    __findAngle([p1x, p1y], [p2x, p2y]) {
        const n = (0,_metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean)([p1x, p1y], [p2x, p2y]);
        if (n === 0)
            return {
                sin: 0,
                cos: 1,
    ...
    __align_hull(hull, p, topEdge) {
        ...
        for (let i = 0; i < hull.length; ++i) {
            const d = (0,_metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean)(hull[i], p);
            if (v === -1) {
                d2 = d;
                v = i;
            } else {
    ...
    transform() {
        ...
        const components = new _datastructure_index_js__WEBPACK_IMPORTED_MODULE_3__.DisjointSet(
            Y.map((y, i) => {
                y.i = i;
                return y;
            })
...
/***/ "./node_modules/@saehrimnir/druidjs/src/dimred/TriMap.js":
/*!***************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/dimred/TriMap.js ***!
  \***************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../matrix/index.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/index.js");
/* harmony import */ var _metrics_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../metrics/index.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/index.js");
/* harmony import */ var _PCA_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./PCA.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/PCA.js");
/* harmony import */ var _knn_index_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../knn/index.js */ "./node_modules/@saehrimnir/druidjs/src/knn/index.js");
/* harmony import */ var _DR_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./DR.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/DR.js");
...
class TriMap extends _DR_js__WEBPACK_IMPORTED_MODULE_4__.DR {
     ...
     */
    constructor(X, parameters) {
        super(X, { weight_adj: 500, c: 5, d: 2, metric: _metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean, tol: 1e-8, seed: 1212 }, parameters);
        return this;
    }
    ...
    init(pca = null, knn = null) {
        ...
        this.n_outliers = 1 * c;
        this.n_random = 1 * c;
        this.Y = pca || new _PCA_js__WEBPACK_IMPORTED_MODULE_2__.PCA(X, { d, seed }).transform();
        this.knn = knn || new _knn_index_js__WEBPACK_IMPORTED_MODULE_3__.BallTree(X.to2dArray, metric);
        ...
        this.C = Infinity;
        this.vel = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, d, 0);
        this.gain = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, d, 1);
        return this;
    }
    ...
    _generate_triplets(n_inliers, n_outliers, n_random) {
        ...
        const nbrs = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, n_extra);
        const knn_distances = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, n_extra);
        for (let i = 0; i < N; ++i) {
    ...
    _find_p(knn_distances, sig, nbrs) {
        ...
        return new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, n_neighbors, (i, j) => {
    ...
    _sample_knn_triplets(P, nbrs, n_inliers, n_outliers) {
        ...
        const triplets = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N * n_inliers * n_outliers, 3);
        for (let i = 0; i < N; ++i) {
     ...
     */
    __argsort(A) {
        return (0,_matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.linspace)(0, A.length - 1).sort((i, j) => A[j] - A[i]);
    }
    ...
    _rejection_sample(n_samples, max_int, rejects) {
        const randomizer = this._randomizer;
        const interval = (0,_matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.linspace)(0, max_int - 1).filter((d) => rejects.indexOf(d) < 0);
    ...
    _sample_random_triplets(X, n_random, sig) {
        ...
        const randomizer = this._randomizer;
        const N = X.shape[0];
        const random_triplets = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N * n_random, 3);
        const random_weights = new Float64Array(N * n_random);
        for (let i = 0; i < N; ++i) {
            const n_i = i * n_random;
            const indices = [...(0,_matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.linspace)(0, i - 1), ...(0,_matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.linspace)(i + 1, N - 1)];
    ...
    _grad(Y) {
        ...
        const [N, dim] = Y.shape;
        const n_triplets = triplets.shape[0];
        const grad = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, dim, 0);
...
/***/ "./node_modules/@saehrimnir/druidjs/src/dimred/UMAP.js":
/*!*************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/dimred/UMAP.js ***!
  \*************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../matrix/index.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/index.js");
/* harmony import */ var _metrics_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../metrics/index.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/index.js");
/* harmony import */ var _knn_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../knn/index.js */ "./node_modules/@saehrimnir/druidjs/src/knn/index.js");
/* harmony import */ var _numerical_index_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../numerical/index.js */ "./node_modules/@saehrimnir/druidjs/src/numerical/index.js");
/* harmony import */ var _optimization_index_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../optimization/index.js */ "./node_modules/@saehrimnir/druidjs/src/optimization/index.js");
/* harmony import */ var _DR_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./DR.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/DR.js");
/* harmony import */ var _util_index_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../util/index.js */ "./node_modules/@saehrimnir/druidjs/src/util/index.js");
...
class UMAP extends _DR_js__WEBPACK_IMPORTED_MODULE_5__.DR {
    ...
    constructor(X, parameters) {
        ...
        this._iter = 0;
        const randomizer = this._randomizer;
        this.Y = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(this._N, this.parameter("d"), () => randomizer.random);
        return this;
    }
    ...
    _find_ab_params(spread, min_dist) {
        ...
        const xv = (0,_matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.linspace)(0, spread * 3, 300);
        const yv = (0,_matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.linspace)(0, spread * 3, 300);
        ...
        const err = (p) => {
            const error = (0,_matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.linspace)(1, 300).map((_, i) => yv[i] - curve(xv[i], p[0], p[1]));
            return Math.sqrt((0,_numerical_index_js__WEBPACK_IMPORTED_MODULE_3__.neumair_sum)(error.map((e) => e * e)));
        };

        return (0,_optimization_index_js__WEBPACK_IMPORTED_MODULE_4__.powell)(err, [1, 1]);
    }
    ...
    _fuzzy_simplicial_set(X, n_neighbors) {
        ...
        const knn = metric === "precomputed" ? new _knn_index_js__WEBPACK_IMPORTED_MODULE_2__.KNN(X, "precomputed") : new _knn_index_js__WEBPACK_IMPORTED_MODULE_2__.BallTree(X.to2dArray, metric);
        ...
        const result = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(N, N, "zeros");
        for (let i = 0; i < N; ++i) {
    ...
    _make_epochs_per_sample(n_epochs) {
        ...
        const weight_scl = n_epochs / (0,_util_index_js__WEBPACK_IMPORTED_MODULE_6__.max)(weights);
        weights.forEach((w, i) => {
    ...
    _optimize_layout(head_embedding, tail_embedding, head, tail) {
        ...
        for (let i = 0, n = epochs_per_sample.length; i < n; ++i) {
            if (epoch_of_next_sample[i] <= this._iter) {
                ...
                const dist = (0,_metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean_squared)(current, other);
                if (dist > 0) {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/dimred/index.js":
/*!**************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/dimred/index.js ***!
  \**************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   FASTMAP: () => (/* reexport safe */ _FASTMAP_js__WEBPACK_IMPORTED_MODULE_3__.FASTMAP),
/* harmony export */   ISOMAP: () => (/* reexport safe */ _ISOMAP_js__WEBPACK_IMPORTED_MODULE_2__.ISOMAP),
/* harmony export */   LDA: () => (/* reexport safe */ _LDA_js__WEBPACK_IMPORTED_MODULE_4__.LDA),
/* harmony export */   LLE: () => (/* reexport safe */ _LLE_js__WEBPACK_IMPORTED_MODULE_5__.LLE),
/* harmony export */   LSP: () => (/* reexport safe */ _LSP_js__WEBPACK_IMPORTED_MODULE_10__.LSP),
/* harmony export */   LTSA: () => (/* reexport safe */ _LTSA_js__WEBPACK_IMPORTED_MODULE_6__.LTSA),
/* harmony export */   MDS: () => (/* reexport safe */ _MDS_js__WEBPACK_IMPORTED_MODULE_1__.MDS),
/* harmony export */   PCA: () => (/* reexport safe */ _PCA_js__WEBPACK_IMPORTED_MODULE_0__.PCA),
/* harmony export */   SAMMON: () => (/* reexport safe */ _SAMMON_js__WEBPACK_IMPORTED_MODULE_12__.SAMMON),
/* harmony export */   SQDMDS: () => (/* reexport safe */ _SQDMDS_js__WEBPACK_IMPORTED_MODULE_13__.SQDMDS),
/* harmony export */   TSNE: () => (/* reexport safe */ _TSNE_js__WEBPACK_IMPORTED_MODULE_7__.TSNE),
/* harmony export */   TopoMap: () => (/* reexport safe */ _TopoMap_js__WEBPACK_IMPORTED_MODULE_11__.TopoMap),
/* harmony export */   TriMap: () => (/* reexport safe */ _TriMap_js__WEBPACK_IMPORTED_MODULE_9__.TriMap),
/* harmony export */   UMAP: () => (/* reexport safe */ _UMAP_js__WEBPACK_IMPORTED_MODULE_8__.UMAP)
/* harmony export */ });
/* harmony import */ var _PCA_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./PCA.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/PCA.js");
/* harmony import */ var _MDS_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MDS.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/MDS.js");
/* harmony import */ var _ISOMAP_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ISOMAP.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/ISOMAP.js");
/* harmony import */ var _FASTMAP_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./FASTMAP.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/FASTMAP.js");
/* harmony import */ var _LDA_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./LDA.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/LDA.js");
/* harmony import */ var _LLE_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./LLE.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/LLE.js");
/* harmony import */ var _LTSA_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./LTSA.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/LTSA.js");
/* harmony import */ var _TSNE_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./TSNE.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/TSNE.js");
/* harmony import */ var _UMAP_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./UMAP.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/UMAP.js");
/* harmony import */ var _TriMap_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./TriMap.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/TriMap.js");
/* harmony import */ var _LSP_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./LSP.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/LSP.js");
/* harmony import */ var _TopoMap_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./TopoMap.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/TopoMap.js");
/* harmony import */ var _SAMMON_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./SAMMON.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/SAMMON.js");
/* harmony import */ var _SQDMDS_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./SQDMDS.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/SQDMDS.js");
/**
...
/***/ "./node_modules/@saehrimnir/druidjs/src/index.js":
/*!*******************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/index.js ***!
  \*******************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   BallTree: () => (/* reexport safe */ _knn_index_js__WEBPACK_IMPORTED_MODULE_4__.BallTree),
/* harmony export */   DisjointSet: () => (/* reexport safe */ _datastructure_index_js__WEBPACK_IMPORTED_MODULE_5__.DisjointSet),
/* harmony export */   FASTMAP: () => (/* reexport safe */ _dimred_index_js__WEBPACK_IMPORTED_MODULE_7__.FASTMAP),
/* harmony export */   Heap: () => (/* reexport safe */ _datastructure_index_js__WEBPACK_IMPORTED_MODULE_5__.Heap),
/* harmony export */   Hierarchical_Clustering: () => (/* reexport safe */ _clustering_index_js__WEBPACK_IMPORTED_MODULE_9__.Hierarchical_Clustering),
/* harmony export */   ISOMAP: () => (/* reexport safe */ _dimred_index_js__WEBPACK_IMPORTED_MODULE_7__.ISOMAP),
/* harmony export */   KMeans: () => (/* reexport safe */ _clustering_index_js__WEBPACK_IMPORTED_MODULE_9__.KMeans),
/* harmony export */   KMedoids: () => (/* reexport safe */ _clustering_index_js__WEBPACK_IMPORTED_MODULE_9__.KMedoids),
/* harmony export */   KNN: () => (/* reexport safe */ _knn_index_js__WEBPACK_IMPORTED_MODULE_4__.KNN),
/* harmony export */   LDA: () => (/* reexport safe */ _dimred_index_js__WEBPACK_IMPORTED_MODULE_7__.LDA),
/* harmony export */   LLE: () => (/* reexport safe */ _dimred_index_js__WEBPACK_IMPORTED_MODULE_7__.LLE),
/* harmony export */   LSP: () => (/* reexport safe */ _dimred_index_js__WEBPACK_IMPORTED_MODULE_7__.LSP),
/* harmony export */   LTSA: () => (/* reexport safe */ _dimred_index_js__WEBPACK_IMPORTED_MODULE_7__.LTSA),
/* harmony export */   MDS: () => (/* reexport safe */ _dimred_index_js__WEBPACK_IMPORTED_MODULE_7__.MDS),
/* harmony export */   Matrix: () => (/* reexport safe */ _matrix_index_js__WEBPACK_IMPORTED_MODULE_3__.Matrix),
/* harmony export */   OPTICS: () => (/* reexport safe */ _clustering_index_js__WEBPACK_IMPORTED_MODULE_9__.OPTICS),
/* harmony export */   PCA: () => (/* reexport safe */ _dimred_index_js__WEBPACK_IMPORTED_MODULE_7__.PCA),
/* harmony export */   Randomizer: () => (/* reexport safe */ _util_index_js__WEBPACK_IMPORTED_MODULE_0__.Randomizer),
/* harmony export */   SAMMON: () => (/* reexport safe */ _dimred_index_js__WEBPACK_IMPORTED_MODULE_7__.SAMMON),
/* harmony export */   SQDMDS: () => (/* reexport safe */ _dimred_index_js__WEBPACK_IMPORTED_MODULE_7__.SQDMDS),
/* harmony export */   TSNE: () => (/* reexport safe */ _dimred_index_js__WEBPACK_IMPORTED_MODULE_7__.TSNE),
/* harmony export */   TopoMap: () => (/* reexport safe */ _dimred_index_js__WEBPACK_IMPORTED_MODULE_7__.TopoMap),
/* harmony export */   TriMap: () => (/* reexport safe */ _dimred_index_js__WEBPACK_IMPORTED_MODULE_7__.TriMap),
/* harmony export */   UMAP: () => (/* reexport safe */ _dimred_index_js__WEBPACK_IMPORTED_MODULE_7__.UMAP),
/* harmony export */   canberra: () => (/* reexport safe */ _metrics_index_js__WEBPACK_IMPORTED_MODULE_2__.canberra),
/* harmony export */   chebyshev: () => (/* reexport safe */ _metrics_index_js__WEBPACK_IMPORTED_MODULE_2__.chebyshev),
/* harmony export */   cosine: () => (/* reexport safe */ _metrics_index_js__WEBPACK_IMPORTED_MODULE_2__.cosine),
/* harmony export */   distance_matrix: () => (/* reexport safe */ _matrix_index_js__WEBPACK_IMPORTED_MODULE_3__.distance_matrix),
/* harmony export */   euclidean: () => (/* reexport safe */ _metrics_index_js__WEBPACK_IMPORTED_MODULE_2__.euclidean),
/* harmony export */   euclidean_squared: () => (/* reexport safe */ _metrics_index_js__WEBPACK_IMPORTED_MODULE_2__.euclidean_squared),
/* harmony export */   hamming: () => (/* reexport safe */ _metrics_index_js__WEBPACK_IMPORTED_MODULE_2__.hamming),
/* harmony export */   inner_product: () => (/* reexport safe */ _linear_algebra_index_js__WEBPACK_IMPORTED_MODULE_6__.inner_product),
/* harmony export */   jaccard: () => (/* reexport safe */ _metrics_index_js__WEBPACK_IMPORTED_MODULE_2__.jaccard),
/* harmony export */   k_nearest_neighbors: () => (/* reexport safe */ _matrix_index_js__WEBPACK_IMPORTED_MODULE_3__.k_nearest_neighbors),
/* harmony export */   kahan_sum: () => (/* reexport safe */ _numerical_index_js__WEBPACK_IMPORTED_MODULE_1__.kahan_sum),
/* harmony export */   linspace: () => (/* reexport safe */ _matrix_index_js__WEBPACK_IMPORTED_MODULE_3__.linspace),
/* harmony export */   manhattan: () => (/* reexport safe */ _metrics_index_js__WEBPACK_IMPORTED_MODULE_2__.manhattan),
/* harmony export */   max: () => (/* reexport safe */ _util_index_js__WEBPACK_IMPORTED_MODULE_0__.max),
/* harmony export */   min: () => (/* reexport safe */ _util_index_js__WEBPACK_IMPORTED_MODULE_0__.min),
/* harmony export */   neumair_sum: () => (/* reexport safe */ _numerical_index_js__WEBPACK_IMPORTED_MODULE_1__.neumair_sum),
/* harmony export */   norm: () => (/* reexport safe */ _matrix_index_js__WEBPACK_IMPORTED_MODULE_3__.norm),
/* harmony export */   normalize: () => (/* reexport safe */ _matrix_index_js__WEBPACK_IMPORTED_MODULE_3__.normalize),
/* harmony export */   powell: () => (/* reexport safe */ _optimization_index_js__WEBPACK_IMPORTED_MODULE_8__.powell),
/* harmony export */   qr: () => (/* reexport safe */ _linear_algebra_index_js__WEBPACK_IMPORTED_MODULE_6__.qr),
/* harmony export */   qr_householder: () => (/* reexport safe */ _linear_algebra_index_js__WEBPACK_IMPORTED_MODULE_6__.qr_householder),
/* harmony export */   simultaneous_poweriteration: () => (/* reexport safe */ _linear_algebra_index_js__WEBPACK_IMPORTED_MODULE_6__.simultaneous_poweriteration),
/* harmony export */   sokal_michener: () => (/* reexport safe */ _metrics_index_js__WEBPACK_IMPORTED_MODULE_2__.sokal_michener),
/* harmony export */   version: () => (/* binding */ version),
/* harmony export */   yule: () => (/* reexport safe */ _metrics_index_js__WEBPACK_IMPORTED_MODULE_2__.yule)
/* harmony export */ });
/* harmony import */ var _util_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util/index.js */ "./node_modules/@saehrimnir/druidjs/src/util/index.js");
/* harmony import */ var _numerical_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./numerical/index.js */ "./node_modules/@saehrimnir/druidjs/src/numerical/index.js");
/* harmony import */ var _metrics_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./metrics/index.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/index.js");
/* harmony import */ var _matrix_index_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./matrix/index.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/index.js");
/* harmony import */ var _knn_index_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./knn/index.js */ "./node_modules/@saehrimnir/druidjs/src/knn/index.js");
/* harmony import */ var _datastructure_index_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./datastructure/index.js */ "./node_modules/@saehrimnir/druidjs/src/datastructure/index.js");
/* harmony import */ var _linear_algebra_index_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./linear_algebra/index.js */ "./node_modules/@saehrimnir/druidjs/src/linear_algebra/index.js");
/* harmony import */ var _dimred_index_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./dimred/index.js */ "./node_modules/@saehrimnir/druidjs/src/dimred/index.js");
/* harmony import */ var _optimization_index_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./optimization/index.js */ "./node_modules/@saehrimnir/druidjs/src/optimization/index.js");
/* harmony import */ var _clustering_index_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./clustering/index.js */ "./node_modules/@saehrimnir/druidjs/src/clustering/index.js");
...
/***/ "./node_modules/@saehrimnir/druidjs/src/knn/BallTree.js":
/*!**************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/knn/BallTree.js ***!
  \**************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
class BallTree {
     ...
     * @returns {BallTree}
     */
    constructor(elements = null, metric = _metrics_index_js__WEBPACK_IMPORTED_MODULE_0__.euclidean) {
        this._Node = class {
     ...
     */
    search(t, k = 5) {
        return this._search(t, k, new _datastructure_index_js__WEBPACK_IMPORTED_MODULE_1__.Heap(null, d => this._metric(d.element, t), "max"), this._root);
    }
...
/***/ "./node_modules/@saehrimnir/druidjs/src/knn/KNN.js":
/*!*********************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/knn/KNN.js ***!
  \*********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
class KNN {
    ...
    constructor(elements=null, metric=_metrics_index_js__WEBPACK_IMPORTED_MODULE_0__.euclidean) {
        this._metric = metric;
        this._elements = elements instanceof _matrix_index_js__WEBPACK_IMPORTED_MODULE_2__.Matrix ? elements : _matrix_index_js__WEBPACK_IMPORTED_MODULE_2__.Matrix.from(elements);
        const N = this._elements.shape[0];
        if (metric === "precomputed") {
            this._D = this._elements.clone();
        } else {
            this._D = (0,_matrix_index_js__WEBPACK_IMPORTED_MODULE_2__.distance_matrix)(this._elements, metric);
        }
        this.KNN = [];
        for (let row = 0; row < N; ++row) {
            const distances = this._D.row(row);
            const H = new _datastructure_index_js__WEBPACK_IMPORTED_MODULE_1__.Heap(null, d => d.value, "min");
            for (let j = 0; j < N; ++j) {
                H.push({
                    value: distances[j],
                    index: j,
...
/***/ "./node_modules/@saehrimnir/druidjs/src/knn/index.js":
/*!***********************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/knn/index.js ***!
  \***********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   BallTree: () => (/* reexport safe */ _BallTree_js__WEBPACK_IMPORTED_MODULE_0__.BallTree),
/* harmony export */   KNN: () => (/* reexport safe */ _KNN_js__WEBPACK_IMPORTED_MODULE_1__.KNN)
/* harmony export */ });
/* harmony import */ var _BallTree_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./BallTree.js */ "./node_modules/@saehrimnir/druidjs/src/knn/BallTree.js");
/* harmony import */ var _KNN_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./KNN.js */ "./node_modules/@saehrimnir/druidjs/src/knn/KNN.js");
/**
 * @module knn
 */
...
/***/ "./node_modules/@saehrimnir/druidjs/src/linear_algebra/index.js":
/*!**********************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/linear_algebra/index.js ***!
  \**********************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   inner_product: () => (/* reexport safe */ _inner_product_js__WEBPACK_IMPORTED_MODULE_3__["default"]),
/* harmony export */   qr: () => (/* reexport safe */ _qr_js__WEBPACK_IMPORTED_MODULE_0__["default"]),
/* harmony export */   qr_householder: () => (/* reexport safe */ _qr_householder_js__WEBPACK_IMPORTED_MODULE_1__["default"]),
/* harmony export */   simultaneous_poweriteration: () => (/* reexport safe */ _simultaneous_poweriteration_js__WEBPACK_IMPORTED_MODULE_2__["default"])
/* harmony export */ });
/* harmony import */ var _qr_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./qr.js */ "./node_modules/@saehrimnir/druidjs/src/linear_algebra/qr.js");
/* harmony import */ var _qr_householder_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./qr_householder.js */ "./node_modules/@saehrimnir/druidjs/src/linear_algebra/qr_householder.js");
/* harmony import */ var _simultaneous_poweriteration_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./simultaneous_poweriteration.js */ "./node_modules/@saehrimnir/druidjs/src/linear_algebra/simultaneous_poweriteration.js");
/* harmony import */ var _inner_product_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./inner_product.js */ "./node_modules/@saehrimnir/druidjs/src/linear_algebra/inner_product.js");
/**
...
/***/ "./node_modules/@saehrimnir/druidjs/src/linear_algebra/inner_product.js":
/*!******************************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/linear_algebra/inner_product.js ***!
  \******************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _numerical_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../numerical/index.js */ "./node_modules/@saehrimnir/druidjs/src/numerical/index.js");
...
/***/ "./node_modules/@saehrimnir/druidjs/src/linear_algebra/qr.js":
/*!*******************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/linear_algebra/qr.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(A) {
    ...
    const Q = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(rows, cols, "identity");
    const R = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(cols, cols, 0);

    for (let j = 0; j < cols; ++j) {
        let v = A.col(j);
        for (let i = 0; i < j; ++i) {
            const q = Q.col(i);
            const q_dot_v = (0,_numerical_index_js__WEBPACK_IMPORTED_MODULE_2__.neumair_sum)(q.map((q_, k) => q_ * v[k]));
            for (let k = 0; k < rows; ++k) {
                v[k] -= q_dot_v * q[k];
            }
            R.set_entry(i, j, q_dot_v);
        }
        const v_norm = (0,_matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.norm)(v, _metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean);
        for (let k = 0; k < rows; ++k) {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/linear_algebra/qr_householder.js":
/*!*******************************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/linear_algebra/qr_householder.js ***!
  \*******************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(A) {
    const [rows, cols] = A.shape;
    const Q = new _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix(rows, rows, "I");
    const R = A.clone();

    for (let j = 0; j < cols; ++j) {
        const x = _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix.from(R.col(j).slice(j));
        const x_norm = (0,_matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.norm)(x);
...
/***/ "./node_modules/@saehrimnir/druidjs/src/linear_algebra/simultaneous_poweriteration.js":
/*!********************************************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/linear_algebra/simultaneous_poweriteration.js ***!
  \********************************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.js */ "./node_modules/@saehrimnir/druidjs/src/linear_algebra/index.js");
/* harmony import */ var _matrix_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../matrix/index.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/index.js");
/* harmony import */ var _util_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../util/index.js */ "./node_modules/@saehrimnir/druidjs/src/util/index.js");
/* harmony import */ var _metrics_index_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../metrics/index.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/index.js");
 ...
 */
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(A, k = 2, {seed = 1212, max_iterations = 100, qr = _index_js__WEBPACK_IMPORTED_MODULE_0__.qr, tol = 1e-8} = {}) {
    const randomizer = seed instanceof _util_index_js__WEBPACK_IMPORTED_MODULE_2__.Randomizer ? seed : new _util_index_js__WEBPACK_IMPORTED_MODULE_2__.Randomizer(seed);
    if (!(A instanceof _matrix_index_js__WEBPACK_IMPORTED_MODULE_1__.Matrix)) A = _matrix_index_js__WEBPACK_IMPORTED_MODULE_1__.Matrix.from(A);
    const n = A.shape[0];
    let { Q, R } = qr(new _matrix_index_js__WEBPACK_IMPORTED_MODULE_1__.Matrix(n, k, () => (randomizer.random - .5) * 2));
    while (max_iterations--) {
        ...
        Q = QR.Q;
        R = QR.R;
        const error = (0,_metrics_index_js__WEBPACK_IMPORTED_MODULE_3__.euclidean_squared)(Q.values, oldQ.values);
        if (error < tol) {
            break;
        }
    }
...
/***/ "./node_modules/@saehrimnir/druidjs/src/matrix/Matrix.js":
/*!***************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/matrix/Matrix.js ***!
  \***************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
    ...
    *[Symbol.iterator]() {
    ...
    dot(B) {
        if (B instanceof Matrix) {
            ...
            for (let row = 0; row < rows; ++row) {
                C[row] = (0,_numerical_index_js__WEBPACK_IMPORTED_MODULE_0__.neumair_sum)(this.row(row).map((e) => e * B[row]));
            }
            return C;
        } else {
    ...
    transDot(B) {
        if (B instanceof Matrix) {
            ...
            let C = new Array(rows);
            for (let row = 0; row < rows; ++row) {
                C[row] = (0,_numerical_index_js__WEBPACK_IMPORTED_MODULE_0__.neumair_sum)(this.col(row).map((e) => e * B[row]));
            }
            return C;
        } else {
            throw new Error(`B must be Matrix or Array`);
    ...
    get sum() {
        const data = this.values;
        return (0,_numerical_index_js__WEBPACK_IMPORTED_MODULE_0__.neumair_sum)(data);
    }
    ...
    static solve_CG(A, b, randomizer, tol = 1e-3) {
        if (randomizer === null) {
            randomizer = new _util_index_js__WEBPACK_IMPORTED_MODULE_2__.Randomizer();
        }
    ...
    static SVD(M, k = 2) {
        ...
        let { eigenvectors: V, eigenvalues: Sigma } = (0,_linear_algebra_index_js__WEBPACK_IMPORTED_MODULE_1__.simultaneous_poweriteration)(MtM, k);
        let { eigenvectors: U } = (0,_linear_algebra_index_js__WEBPACK_IMPORTED_MODULE_1__.simultaneous_poweriteration)(MMt, k);
...
/***/ "./node_modules/@saehrimnir/druidjs/src/matrix/distance_matrix.js":
/*!************************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/matrix/distance_matrix.js ***!
  \************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _metrics_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../metrics/index.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/index.js");
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/index.js");
 ...
 */
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(A, metric = _metrics_index_js__WEBPACK_IMPORTED_MODULE_0__.euclidean) {
    let n = A.shape[0];
    const D = new _index_js__WEBPACK_IMPORTED_MODULE_1__.Matrix(n, n);
    for (let i = 0; i < n; ++i) {
        const A_i = A.row(i);
        for (let j = i + 1; j < n; ++j) {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/matrix/index.js":
/*!**************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/matrix/index.js ***!
  \**************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Matrix: () => (/* reexport safe */ _Matrix_js__WEBPACK_IMPORTED_MODULE_5__.Matrix),
/* harmony export */   distance_matrix: () => (/* reexport safe */ _distance_matrix_js__WEBPACK_IMPORTED_MODULE_1__["default"]),
/* harmony export */   k_nearest_neighbors: () => (/* reexport safe */ _k_nearest_neighbors_js__WEBPACK_IMPORTED_MODULE_0__["default"]),
/* harmony export */   linspace: () => (/* reexport safe */ _linspace_js__WEBPACK_IMPORTED_MODULE_2__["default"]),
/* harmony export */   norm: () => (/* reexport safe */ _norm_js__WEBPACK_IMPORTED_MODULE_3__["default"]),
/* harmony export */   normalize: () => (/* reexport safe */ _normalize_js__WEBPACK_IMPORTED_MODULE_4__["default"])
/* harmony export */ });
/* harmony import */ var _k_nearest_neighbors_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./k_nearest_neighbors.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/k_nearest_neighbors.js");
/* harmony import */ var _distance_matrix_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./distance_matrix.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/distance_matrix.js");
/* harmony import */ var _linspace_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./linspace.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/linspace.js");
/* harmony import */ var _norm_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./norm.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/norm.js");
/* harmony import */ var _normalize_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./normalize.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/normalize.js");
/* harmony import */ var _Matrix_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Matrix.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/Matrix.js");
/**
 * @module matrix
 */
...
/***/ "./node_modules/@saehrimnir/druidjs/src/matrix/k_nearest_neighbors.js":
/*!****************************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/matrix/k_nearest_neighbors.js ***!
  \****************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
 ...
 */
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(A, k, metric = _metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean) {
    const rows = A.shape[0];
    let D = metric == "precomputed" ? A : (0,_matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.distance_matrix)(A, metric);
...
/***/ "./node_modules/@saehrimnir/druidjs/src/matrix/linspace.js":
/*!*****************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/matrix/linspace.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/matrix/norm.js":
/*!*************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/matrix/norm.js ***!
  \*************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
 ...
 */
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(v, metric = _metrics_index_js__WEBPACK_IMPORTED_MODULE_0__.euclidean) {
    let vector = null;
    if (v instanceof _matrix_index_js__WEBPACK_IMPORTED_MODULE_1__.Matrix) {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/matrix/normalize.js":
/*!******************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/matrix/normalize.js ***!
  \******************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.js */ "./node_modules/@saehrimnir/druidjs/src/matrix/index.js");
/* harmony import */ var _metrics_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../metrics/index.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/index.js");
 ...
 */
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(v, metric = _metrics_index_js__WEBPACK_IMPORTED_MODULE_1__.euclidean)  {
    const v_norm = (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.norm)(v, metric);
    return v.map(value => value / v_norm);
}

/***/ }),

/***/ "./node_modules/@saehrimnir/druidjs/src/metrics/canberra.js":
/*!******************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/metrics/canberra.js ***!
  \******************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/metrics/chebyshev.js":
/*!*******************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/metrics/chebyshev.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/metrics/cosine.js":
/*!****************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/metrics/cosine.js ***!
  \****************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/metrics/euclidean.js":
/*!*******************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/metrics/euclidean.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/metrics/euclidean_squared.js":
/*!***************************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/metrics/euclidean_squared.js ***!
  \***************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/metrics/hamming.js":
/*!*****************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/metrics/hamming.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/metrics/index.js":
/*!***************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/metrics/index.js ***!
  \***************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   canberra: () => (/* reexport safe */ _canberra_js__WEBPACK_IMPORTED_MODULE_5__["default"]),
/* harmony export */   chebyshev: () => (/* reexport safe */ _chebyshev_js__WEBPACK_IMPORTED_MODULE_4__["default"]),
/* harmony export */   cosine: () => (/* reexport safe */ _cosine_js__WEBPACK_IMPORTED_MODULE_2__["default"]),
/* harmony export */   euclidean: () => (/* reexport safe */ _euclidean_js__WEBPACK_IMPORTED_MODULE_0__["default"]),
/* harmony export */   euclidean_squared: () => (/* reexport safe */ _euclidean_squared_js__WEBPACK_IMPORTED_MODULE_1__["default"]),
/* harmony export */   hamming: () => (/* reexport safe */ _hamming_js__WEBPACK_IMPORTED_MODULE_7__["default"]),
/* harmony export */   jaccard: () => (/* reexport safe */ _jaccard_js__WEBPACK_IMPORTED_MODULE_6__["default"]),
/* harmony export */   manhattan: () => (/* reexport safe */ _manhattan_js__WEBPACK_IMPORTED_MODULE_3__["default"]),
/* harmony export */   sokal_michener: () => (/* reexport safe */ _sokal_michener_js__WEBPACK_IMPORTED_MODULE_8__["default"]),
/* harmony export */   yule: () => (/* reexport safe */ _yule_js__WEBPACK_IMPORTED_MODULE_9__["default"])
/* harmony export */ });
/* harmony import */ var _euclidean_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./euclidean.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/euclidean.js");
/* harmony import */ var _euclidean_squared_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./euclidean_squared.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/euclidean_squared.js");
/* harmony import */ var _cosine_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cosine.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/cosine.js");
/* harmony import */ var _manhattan_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./manhattan.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/manhattan.js");
/* harmony import */ var _chebyshev_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./chebyshev.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/chebyshev.js");
/* harmony import */ var _canberra_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./canberra.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/canberra.js");
/* harmony import */ var _jaccard_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./jaccard.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/jaccard.js");
/* harmony import */ var _hamming_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./hamming.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/hamming.js");
/* harmony import */ var _sokal_michener_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./sokal_michener.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/sokal_michener.js");
/* harmony import */ var _yule_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./yule.js */ "./node_modules/@saehrimnir/druidjs/src/metrics/yule.js");
/**
 * @module metrics
 */
...
/***/ "./node_modules/@saehrimnir/druidjs/src/metrics/jaccard.js":
/*!*****************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/metrics/jaccard.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/metrics/manhattan.js":
/*!*******************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/metrics/manhattan.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/metrics/sokal_michener.js":
/*!************************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/metrics/sokal_michener.js ***!
  \************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/metrics/yule.js":
/*!**************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/metrics/yule.js ***!
  \**************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/numerical/index.js":
/*!*****************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/numerical/index.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   kahan_sum: () => (/* reexport safe */ _kahan_sum_js__WEBPACK_IMPORTED_MODULE_0__["default"]),
/* harmony export */   neumair_sum: () => (/* reexport safe */ _neumair_sum_js__WEBPACK_IMPORTED_MODULE_1__["default"])
/* harmony export */ });
/* harmony import */ var _kahan_sum_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./kahan_sum.js */ "./node_modules/@saehrimnir/druidjs/src/numerical/kahan_sum.js");
/* harmony import */ var _neumair_sum_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./neumair_sum.js */ "./node_modules/@saehrimnir/druidjs/src/numerical/neumair_sum.js");
/**
 * @module numerical
 */
...
/***/ "./node_modules/@saehrimnir/druidjs/src/numerical/kahan_sum.js":
/*!*********************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/numerical/kahan_sum.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/numerical/neumair_sum.js":
/*!***********************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/numerical/neumair_sum.js ***!
  \***********************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/optimization/index.js":
/*!********************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/optimization/index.js ***!
  \********************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   powell: () => (/* reexport safe */ _powell_js__WEBPACK_IMPORTED_MODULE_0__["default"])
/* harmony export */ });
/* harmony import */ var _powell_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./powell.js */ "./node_modules/@saehrimnir/druidjs/src/optimization/powell.js");
/** @module optimization */


/***/ }),

/***/ "./node_modules/@saehrimnir/druidjs/src/optimization/powell.js":
/*!*********************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/optimization/powell.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/util/index.js":
/*!************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/util/index.js ***!
  \************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Randomizer: () => (/* reexport safe */ _randomizer_js__WEBPACK_IMPORTED_MODULE_0__.Randomizer),
/* harmony export */   max: () => (/* reexport safe */ _max_js__WEBPACK_IMPORTED_MODULE_1__["default"]),
/* harmony export */   min: () => (/* reexport safe */ _min_js__WEBPACK_IMPORTED_MODULE_2__["default"])
/* harmony export */ });
/* harmony import */ var _randomizer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./randomizer.js */ "./node_modules/@saehrimnir/druidjs/src/util/randomizer.js");
/* harmony import */ var _max_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./max.js */ "./node_modules/@saehrimnir/druidjs/src/util/max.js");
/* harmony import */ var _min_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./min.js */ "./node_modules/@saehrimnir/druidjs/src/util/min.js");
/**
 * @module utils
 */
...
/***/ "./node_modules/@saehrimnir/druidjs/src/util/max.js":
/*!**********************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/util/max.js ***!
  \**********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/util/min.js":
/*!**********************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/util/min.js ***!
  \**********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@saehrimnir/druidjs/src/util/randomizer.js":
/*!*****************************************************************!*\
  !*** ./node_modules/@saehrimnir/druidjs/src/util/randomizer.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
class Randomizer {
     ...
     */
    choice(A, n) {
        if (A instanceof _matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.Matrix) {
            let rows = A.shape[0];
            if (n > rows) {
                throw new Error("n bigger than A!");
            }
            let sample = new Array(n);
            let index_list = (0,_matrix_index_js__WEBPACK_IMPORTED_MODULE_0__.linspace)(0, rows - 1);
...
self.onmessage = async (event) => {
    ...
    if (type === 'reduceDimensions') {
        const { featureVectors, songIds, method, dimensions, 
        // Destructure specific params
        perplexity, neighbors, minDist } = payload;
        console.log('[Druid Worker] Destructured payload:', { method, dimensions, perplexity, neighbors, minDist, vectorCount: featureVectors === null || featureVectors === void 0 ? void 0 : featureVectors.length, idCount: songIds === null || songIds === void 0 ? void 0 : songIds.length });
        ...
        try {
            ...
            const matrix = _saehrimnir_druidjs__WEBPACK_IMPORTED_MODULE_0__.Matrix.from(featureVectors);
            let drInstance; // Use the base DR type or a union type if stricter typing is needed
            // Instantiate the correct DR method
            switch (method) {
                case 'pca':
                    // PCA constructor likely expects options object: (X: Matrix | number[][], parameters?: { d?: number })
                    drInstance = new _saehrimnir_druidjs__WEBPACK_IMPORTED_MODULE_0__.PCA(matrix, { d: dimensions }); // Pass dimensions inside an object
                    break;
                case 'tsne':
                    ...
                    drInstance = new _saehrimnir_druidjs__WEBPACK_IMPORTED_MODULE_0__.TSNE(matrix, {
                        d: dimensions,
                        perplexity: perplexity !== null && perplexity !== void 0 ? perplexity : 30, // Default perplexity if not provided
    ...
    if (type === 'transformNewData') {
        const { newVectors, songIds, method, dimensions, trainingVectors, perplexity, neighbors, minDist } = payload;
        ...
        const trainingVectorDim = (_a = trainingVectors[0]) === null || _a === void 0 ? void 0 : _a.length;
        ...
        try {
            ...
            if (method === 'pca') {
                ...
                const trainingMatrix = _saehrimnir_druidjs__WEBPACK_IMPORTED_MODULE_0__.Matrix.from(trainingVectors);
                const pcaModel = new _saehrimnir_druidjs__WEBPACK_IMPORTED_MODULE_0__.PCA(trainingMatrix, { d: dimensions });
                ...
                if (Array.isArray(transformedResult)) {
                    ...
                    if (transformedResult.length > 0 && Array.isArray(transformedResult[0])) {
                        transformedNewData = transformedResult;
                    }
                    else {
                ...
                else if (transformedResult instanceof _saehrimnir_druidjs__WEBPACK_IMPORTED_MODULE_0__.Matrix) {
                    transformedNewData = transformedResult.to2dArray;
                }
                else {
                    // Fallback: try to access as array property
                    const fallbackArray = transformedResult.to2dArray || transformedResult.asArray || [];
                    // Ensure it's 2D
                ...
                switch (method) {
                    case 'tsne':
                        drInstance = new _saehrimnir_druidjs__WEBPACK_IMPORTED_MODULE_0__.TSNE(combinedMatrix, {
                            d: dimensions,
